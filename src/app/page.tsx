...
const projects = [
  ...
  },
  {
    ...
    bullets: [
      "A community of cold approachers — the guys actually going out and talking to strangers, in one room together comparing what worked last night. Live on the Apple App Store and Google Play, completely free with no paywall, with 220+ users and $250+ in revenue earned before it went free",
