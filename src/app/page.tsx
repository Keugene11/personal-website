...
const projects = [
  ...
  },
  {
    ...
    bullets: [
      "Founding-engineer challenge submission for Prox Technologies — an AI support agent for the Vulcan OmniPro 220 industrial welding machine that turns a 48-page manual into an expert you can talk to",
      ...
      "Multimodal responses surface relevant manual diagrams and schematics alongside text — duty cycles, polarity setups, wire feed troubleshooting, and weld diagnosis",
