...
const projects = [
  {
    ...
    bullets: [
      ...
      "The community is a Discord-style chat channel — one live room everyone's in, with replies, emoji reactions, edit and delete, @mentions and moderation, reached through a left slide-out drawer. On top of that: Find-a-Wingman pairing by city with group chats and DMs, a live map of who's out right now, a board to vote on what gets built next, and long-form articles on the fundamentals",
